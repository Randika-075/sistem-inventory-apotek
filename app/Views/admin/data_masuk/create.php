    ...
    <form method="POST" action="<?= route_to('data_masuk/store'); ?>">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="datetime-local" class="form-control" id="tanggal" placeholder="Masukkan tanggal" value="<?= date('Y-m-d'); ?>" name="tanggal" required autocomplete="tanggal">
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control" id="tanggal_kadaluarsa" placeholder="Masukkan tanggal kadaluarsa" value="<?= date('Y-m-d'); ?>" name="tanggal_kadaluarsa" required autocomplete="tanggal_kadaluarsa">
